...
macro(oryol_config_postfixes_for_exe target)
    if (NOT ORYOL_ANDROID)
        if (ORYOL_EMSCRIPTEN)
            ...
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _prof.html)
            set_target_properties(${target} PROPERTIES TRACING_POSTFIX _trace.html)
        elseif (ORYOL_PNACL)
            ...
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _prof.pexe)
        else()
            # set_target_properties(${target} PROPERTIES RELEASE_POSTFIX "")
            set_target_properties(${target} PROPERTIES DEBUG_POSTFIX _debug)
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _prof)
        endif()
    endif()
...
function(oryol_exe_output_directory target)
    if (NOT (ORYOL_IOS OR ORYOL_ANDROID))
        ...
        set_target_properties(${target} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_TRACING ${dir})
        ...
        set_target_properties(${target} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_TRACING ${dir})
    endif()
endfunction()
