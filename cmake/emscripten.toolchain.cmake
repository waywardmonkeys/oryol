...
# Find the appropriate cache directory
if ("${CMAKE_BUILD_TYPE}" STREQUAL "tracing")
  get_filename_component(EMSCRIPTEN_CACHE_DIR "${EMSCRIPTEN_ROOT_PATH}/../emscripten_tracing_cache" ABSOLUTE)
else()
  get_filename_component(EMSCRIPTEN_CACHE_DIR "${EMSCRIPTEN_ROOT_PATH}/../emscripten_cache" ABSOLUTE)
endif()
...
set(EMSCRIPTEN_CONFIG_OPTIONS "${EMSCRIPTEN_CONFIG_OPTIONS} --cache ${EMSCRIPTEN_CACHE_DIR}")
...
set(CMAKE_CXX_FLAGS_TRACING "-O3 --tracing -DORYOL_TRACING=1")
...
set(CMAKE_C_FLAGS_TRACING "-O3 --tracing -DORYOL_TRACING=1")
...
set(CMAKE_EXE_LINKER_FLAGS_TRACING "--tracing -O3 --llvm-lto ${EMSCRIPTEN_LTO_LEVEL} -s VERBOSE=${EMSCRIPTEN_BUILD_VERBOSE} -s ASM_JS=1 -s ASSERTIONS=${EMSCRIPTEN_ASSERTIONS} -s OUTLINING_LIMIT=${EMSCRIPTEN_OUTLINING_LIMIT}")
...
set(CMAKE_SHARED_LINKER_FLAGS_TRACING "--tracing -O3 --llvm-lto ${EMSCRIPTEN_LTO_LEVEL} -s VERBOSE=${EMSCRIPTEN_BUILD_VERBOSE} -s ASM_JS=1 -s ASSERTIONS=${EMSCRIPTEN_ASSERTIONS} -s OUTLINING_LIMIT=${EMSCRIPTEN_OUTLINING_LIMIT}")
